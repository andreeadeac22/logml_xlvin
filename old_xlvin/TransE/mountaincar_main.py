...
class MountainCarTransE(nn.Module):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='./mountaincar/')

    args = parser.parse_args()

    transe = MountainCarTransE(embedding_dim=50, input_dims=2, hidden_dim=16, action_dim=3)
    ...
    torch.save(transe.state_dict(), os.path.join(args.save_dir, 'mountaincar_transe.pt'))
